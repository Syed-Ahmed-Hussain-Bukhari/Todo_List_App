                 ...
                 SizedBox(height: MediaQuery.sizeOf(context).height*0.02,),
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: Text("Login with Google",style: TextStyle(fontFamily: "Gilroy-Bold",fontSize: 20,color: Colors.black,),
                      ),
                      style: ElevatedButton.styleFrom(
                        shape: StadiumBorder(),
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: Text("Login with Apple",style: TextStyle(fontFamily: "Gilroy-Bold",fontSize: 20,color: Colors.black,),
                      ),
                      style: ElevatedButton.styleFrom(
                        shape: StadiumBorder(),
                        backgroundColor: Colors.white,
